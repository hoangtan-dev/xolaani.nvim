...
function M.setup(config)
    ...
    return {
        ...
        DiffAdd = { bg = palette.kuroiBlue, fg = palette.kairoBlue },
        DiffChange = { bg = palette.yoru0, fg = palette.tsuki3 },
        DiffDelete = { bg = palette.kuroiRed, fg = palette.kairoRed },
        DiffText = { bg = palette.yoru0, fg = palette.tsuki3 },
        ...
        StatusLine = { bg = "none", fg = palette.tsuki4 },
        StatusLineNC = { bg = "none", fg = palette.tsuki4 },
